...
export class Iteracion121717290411949 implements MigrationInterface {
    name = 'Iteracion121717290411949'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "academic_data" ("id" SERIAL NOT NULL, "academic_title" character varying(255) NOT NULL, "institution_name" character varying(255) NOT NULL, "nationality" character varying(50) NOT NULL, "degree_date" TIMESTAMP NOT NULL, "study_type_id" integer, "user_id" integer, CONSTRAINT "PK_461f2d5b8260198f2a65f0246f4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "academic_data" ADD CONSTRAINT "FK_cce51672a0fc37f7baef2145c3f" FOREIGN KEY ("study_type_id") REFERENCES "study_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "academic_data" DROP CONSTRAINT "FK_cce51672a0fc37f7baef2145c3f"`);
